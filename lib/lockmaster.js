 ...
 *
 * In real life, a Lockmaster is the person in charge of a lock and dam.
 *
    ...
    _.each(config.soda, function(sodaConfig) {
        ...
        loaders[riverName + ' ' + streamName] = function(localCallback) {
            ...
            if (streamName && streamName !== river.name) {
                me.dataClient.getEarliestTimestampForRiverStream(riverName, streamName, fetchSodaData);
            } else {
                me.dataClient.getEarliestTimestampForRiver(riverName, fetchSodaData);
            }
        };
    });
